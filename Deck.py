import random
from Card import Card, RANK_VALUE, SUIT_VALUE
...
class Deck:
    ...
    def plays(self):
        ...
        for n in self.plays:
            self.set_plays[n] = []
            for play in self.plays[n]:
                self.set_plays[n].append((play[0], set(play[1])))
        self.plays = self.set_plays
